...
var CELULAR_EMPRESA = '5511957870362';
...
cardapio.metodos = {
    ...
    voltarEtapa: () => {
        ...
        cardapio.metodos.carregaEtapa(etapa - 1);
    ...
    carregarCarrinho: () => {
        ...
        cardapio.metodos.carregaEtapa(1);
    ...
    atualizarCarrinho: (id, qntd) => {
        ...
        // atualiza o botão carrinho com a qauntidade atualizada
        cardapio.metodos.atualizarBadgeTotal();
    ...
    // carrega os avlores de subtotal, entrega e total
    carregarValores: () => {
    ...
    carregarEndereco: () => {
        ...
        cardapio.metodos.carregaEtapa(2);
    ...
    buscarCep: () => {
        ...
        // cria avariavel com o valor do cep
    ...
    resumoPedido: () => {
        ...
        cardapio.metodos.carregaEtapa(3);
    ...
    //carrega o link do botão reservar
    ...
    // careega o botão de fazer ligação
    carregarBotaoLigar: () => {
